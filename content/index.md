...
## 개발 (Development)
- [[summaries/development/linux-commands]] — Linux 필수 명령어 (파일, grep, find, 디스크, 프로세스)
- [[summaries/development/git-commands]] — Git 필수 명령어 (브랜치, 되돌리기, stash, submodule)
- [[summaries/development/docker-commands]] — Docker 필수 명령어 (컨테이너, 이미지, 네트워크)
...
## IDE 도구 (IDE)
- [[summaries/ide/vscode-shortcuts]] — VSCode에서 태그 선택 및 코드 정렬 단축키 (더블 클릭, Shift+Alt+F)
- [[summaries/ide/eclipse-shortcut]] — 이클립스에서 여는태그와 닫는태그를 한번에 선택하는 단축키 (Alt+Shift+A)
...
- [[sources/developers-cheatsheet]] — 개발자 치트시트 (Linux, Git, Docker, CMake, SQL, Java)

## 작업 로그

자세한 작업 내용은 [[log.md]]에서 확인할 수 있습니다.
