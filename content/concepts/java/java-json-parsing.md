...
1. **gson**+ **common-io**아래의 dependency library 를 필요로합니다. 
...
2. **Spring RestTemplate**
   ...
   vars.put("hotel", "42");
   vars.put("booking", "21");
   String result2 = restTemplate.getForObject("http://example.com/hotels/{hotel}/bookings/{booking}", String.class, vars);
   ```
